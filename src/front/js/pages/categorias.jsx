                  ...
                  <td className="td">
                    <div className="dropdown">
                      ...
                      <ul className="dropdown-menu" style={{borderRadius:"8px"}}>
                        <Link to={`/modificar_categorias/${item.id}`} style={{textDecoration:"none"}}>
                        ...
                        <li><a onClick={() => actions.deleteCategories(item.id)} className="dropdown-item" href="#" style={{width:"90%", margin:"auto", borderRadius:"8px"}}>
