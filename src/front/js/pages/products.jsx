                  ...
                  <td className="td">
                    <div className="dropdown">
                      ...
                      <ul className="dropdown-menu" style={{borderRadius:"8px"}}>
                        <Link to={`/modificar/${item.id}`} style={{textDecoration:"none"}}>
                        ...
                        <li onClick={() => actions.deleteProduct(item.id)}><a className="dropdown-item" href="#" style={{width:"90%", margin:"auto", borderRadius:"8px"}}>
