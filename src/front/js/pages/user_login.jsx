        ...
        <div>
            {selectedOption === null && (
                <div class="modal-body" style={{
                    ...
                    <div><h1>Que tipo de usuario eres?</h1></div>
                    <button onClick={() => setSelectedOption('user')}>Login Usuario</button>
                    <button onClick={() => setSelectedOption('admin')}>Login Admin</button>
                </div>
            )}
            ...
            {selectedOption === 'user' && (
                <div onSubmit={loguearUser}>
                    <div class="modal-header border-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-arrow-left-circle" viewBox="0 0 16 16" onClick={() => setSelectedOption(null)}>
            ...
            {selectedOption === 'admin' && (
                <div onSubmit={loguearAdmin}>
                    <div class="d-flex justify-content-between modal-header border-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-arrow-left-circle" viewBox="0 0 16 16" onClick={() => setSelectedOption(null)}>
                            <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-4.5-.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z"/>
                        </svg>
                        <h5 class="modal-title fs-3 fw-bold" id="userModalLabel">Sign Up</h5>
